...
void login() {
  ...
  if (_formKey.currentState!.validate()) {
    ServerUserAPI.checkUser(nationalId, password).then((result) {
      ...
      if (isAuthenticated) {
        if (userType == "Worker") {
          Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => WorkerPage()));
        } else {
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintStyle: TextStyle(color: Color.fromARGB(255, 255, 255, 255).withOpacity(0.7)),
                    ...
                    ElevatedButton(
                      ...
                      child: Text(
                        'Sign In',
                        style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Color(0XFF3A50C2)),
                      ),
                    ),
                    SizedBox(height: 20),
                        TextButton(
